...
- **Branch:** `v1.x-proto`
- **Python:** ≥ 3.10
- **Version:** `1.0.0b2`. The `1.0.0a8` cluster (RFP-001 through RFP-007) remains frozen as history. This beta extends the prototype catalog with RFP-008 and RFP-009. See `CHANGELOG.md`.
